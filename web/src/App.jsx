...
import first from "./assets/pic.jpg";
import second from "./assets/pic1.jpg";
import third from "./assets/pic2.jpg";
import fourth from "./assets/pic3.jpg";

function App() {
  return (
    <div className="bg-white dark:bg-black text-black dark:text-white font-bold text-4xl overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 h-screen items-center justify-center">
        <div className="col-span-1 h-full flex items-center justify-center">
          ...
          <div className="">
            <TextReveal>Hey, I'm Kojo Wiafe. A full stack developer</TextReveal>
          </div>
          {/* <DockTheme /> */}
